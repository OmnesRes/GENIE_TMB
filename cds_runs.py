...
pcawg_maf = pcawg_maf.loc[pcawg_maf['CDS'] > 0]
...
for panel in panels['Panel'].values:
    if panel in to_use:
        ...
        results[panel] = {'predictions': predictions, 'panel_counts': panel_samples.panel_cds_counts.values, 'y_true': y_label[:, 0], 'weights': best_weights, 'metrics': [mse, mae, r2]}
